        ...
        <div class="bg-white w-full max-w-sm p-10 rounded-2xl shadow-lg">
            ...
            <form @submit.prevent="submitForm" class="space-y-8">
                ...
                <div>
                    ...
                    <!-- Error Message -->
                    <p v-if="emailError" class="text-red-500 text-xs mt-1">유효한 이메일 형식이 아닙니다</p>
                </div>
                ...
                <!-- Re-enter Password -->
                <div>
                    <label for="re-password" class="block text-darkBlue text-sm font-title mb-2">RE-ENTER PASSWORD</label>
                ...
                <div>
                    ...
                    <input id="phone" type="text" v-model="phoneNumber" @input="formatPhoneNumber" placeholder="010-0000-0000" required
                        class="w-full px-4 py-2 border border-gray-100 rounded-full shadow-md focus:outline-none focus:ring-2 focus:ring-lightBlue font-title text-darkBlue text-sm" />
                </div>
